    ...
    if (document.getElementById(objid) != null) {
        ...
        for (var e = 0; e < elements.length; e++) {
            if (elements[e].checked == true) {
                var c =
                    s + "," + elements[e].labels[0].innerText.toString().trim();
                if (c.length < 10) {
                    if (s.length > 0) {
                        s = s + ",";
                        tip = tip + ",";
                    ...
                    tip =
                        tip + elements[e].labels[0].innerText.toString().trim();
                } else {
                    if (s.length == 0) {
                        s =
                            s +
                            elements[e].labels[0].innerText.toString().trim();
                    } else {
                        tip = tip + ",";
                    }
                    tip =
...
function ShowMList2(winid, objid, btnid) {
    ...
    if (objparent != null) {
        ...
        for (var th = 0; th < objths.length; th++) {
            ...
            if (
                winid.replace("_cblMultiWin", "").indexOf(objchk.id) == -1 ||
                th == 0 ||
                objchk.id.length == 0
            ) {
            ...
            if (cbllabel.length > 0) {
                ...
                if (cblarShow.length > 1) {
                    ...
                    for (var e = 1; e < cblarShow.length; e++) {
                        ...
                        cbltbRef[0].rows[r]
                            .insertCell(cbltbRef[0].rows[r].cells.length)
...
function HideMList2(objid, lblid) {
    if (document.getElementById(objid) != null) {
        ...
        var divRef = document.getElementById(objid);
        var hdlRef = document.getElementById(
            lblid.replace("_hshow", "_hdcheck")
        );
        var divListRef = document.getElementById(
            objid.replace("_cblMultiWin", "_cblMultiList")
        );
        var tables = divListRef.getElementsByTagName("table");
        for (var t = 0; t < tables.length; t++) {
            if (tables[t].id.indexOf("_show") > 0) {
                var ListRef = document.getElementById(
                    tables[t].id.replace("_show", "")
                );
        ...
        if (document.getElementById(lblid.replace("_hshow", "_htxt")) != null) {
            var keyRef = document.getElementById(
                lblid.replace("_hshow", "_htxt")
            );
            keyRef.value = "";
        }
        document.getElementById(objid).style.display = "none";
        ...
        for (var e = 0; e < elements.length; e++) {
            if (elements[e].checked == true) {
                ...
                h =
                    h +
                    elements[e].id
                        .substring(elements[e].id.lastIndexOf("_"))
                        .toString();
            }
        }
            ...
            if (s.length > 0) {
                ...
                for (var e = 0; e < elements.length; e++) {
                    if (elements[e].checked == true) {
                        if (
                            re.exec(
                                elements[e].id.replace(new RegExp(" ", "g"), "")
                            ) == null
                        ) {
...
function setascblMulti(objwindow, obj) {
    ...
    //顯示在上面
    if (
        (setTop + objwindow.offsetHeight > pageHeight &&
            setTop - objwindow.offsetHeight >= 0) ||
        (setTop + objwindow.offsetHeight > viewHeight &&
            objviewTop - objHeight - objwindow.offsetHeight >= 0)
    ) {
...
function ShowgrdMList(winid, objid, btnid, mid) {
    ...
    var divRef = document.getElementById(objid);
    if (cbllistRef != null) {
        var hdcblRef = document.getElementById(
            objid.replace("_cblMultiList", "_hfcblvalue")
        );
...
function HidegrdMList(objid, lblid, mid) {
    if (document.getElementById(objid) != null) {
        ...
        var hdcblRef = document.getElementById(
            lblid.replace("_hshow", "_hfcblvalue")
        );
        var divListRef = document.getElementById(
            objid.replace("_cblMultiWin", "_cblMultiList")
        );
...
function CancelgrdMList(winid, objid, txtid, mid) {
    ...
    var lblRef = document.getElementById(txtid.replace("_htxt", "_hdcheck"));
    var hdcblRef = document.getElementById(
        txtid.replace("_htxt", "_hfcblvalue")
    );
    var tables = divRef.getElementsByTagName("table");
    for (var t = 0; t < tables.length; t++) {
        if (tables[t].id.indexOf("_show") > 0) {
            ...
            switch (key) {
                ...
                case 37: //←
                    ...
                    if (objtable != null && objprevious != null) {
                        ...
                        var elements =
                            objprevious.getElementsByTagName("input");
                        ...
                        if (elements[itm] != null) {
                            if (elements[itm].getAttribute("type") == "text") {
                                ...
                                if (!elements[itm].readOnly) {
                                    ...
                                    while (tar.readOnly) {
                                        if (
                                            objprevious.previousElementSibling !=
                                            null
                                        ) {
                                            if (
                                                objprevious
                                                ...
                                                if (
                                                    ...
                                                    var elements =
                                                        objprevious.getElementsByTagName(
                                                            "input"
                                                        );
                                                    if (elements[itm] != null) {
                                                        if (
                        ...
                        if (elements[itm] != null) {
                            if (elements[itm].getAttribute("type") == "text") {
                                ...
                                if (!elements[itm].readOnly) {
                                    ...
                                    while (tar.readOnly) {
                                        if (
                                            objnext.nextElementSibling != null
                                        ) {
                                            if (
...
function show_help(sApiFullName, sPageID) {
    ...
    var content =
        "<html><head><title>操作說明</title><link href='Styles/asHelp.css' type='text/css' rel='stylesheet'></head>";
    ...
    if (helppage) {
        if (helppage.length == 0) {
            var astitlename =
                iframeobj.contentDocument.getElementById("titlename");
            if (astitlename) {
    ...
    content += "<body>";
    content +=
        "<div id=asHelp><div id=asPageButtom></div><div id='asPagediv' style='width: 99vw;height: 95%;float: left;text-align: center;/*background: #464343;*/'><img src='../images/新校務建置中_檔案建置中.png' alt='建置中'></div><iframe id='asPage' style='width: 99vw;height: 95%;' frameborder='no'></iframe></body>";
    content += "</html>";
    ...
    if (!HelpWin.document.getElementById("tab" + sPageID)) {
        if (helppage) {
            if (helppage.length != 0) {
                ...
                if (str[1].length > 0) {
                    asRblPage.setAttribute(
                        "onclick",
                        "document.getElementById('asPage').src='" +
                            str[1] +
                            "';document.getElementById('asPage').style.display='block';document.getElementById('asPagediv').style.display='none';var objtab = document.getElementsByName('tabPanel');for(var sPanel = 0; sPanel < objtab.length;sPanel++){objtab[sPanel].style.display='none';document.getElementById('asPage').style.display='block';}"
                    );
                    ...
                    asRblPage.setAttribute(
                        "onclick",
                        "document.getElementById('asPage').style.display='none';document.getElementById('asPagediv').style.display='block';var objtab = document.getElementsByName('tabPanel');for(var sPanel = 0; sPanel < objtab.length;sPanel++){objtab[sPanel].style.display='none';document.getElementById('asPage').style.display='block';}"
                    );
                }
                ...
                asClassPage.setAttribute(
                    "onclick",
                    "let nPage = document.getElementById('page" +
                        sPageID +
                        "').nextElementSibling;let lPage = document.getElementById('page" +
                        sPageID +
                        "').previousElementSibling;if(nPage){nPage.children[0].click();}else if(lPage){lPage.children[0].click();}else{window.close();}let node = document.getElementById('page" +
                        sPageID +
...
function setascblchange(obj) {
    var cblid = obj
        ...
        .id.substr(0, obj.getElementsByTagName("input")[0].id.lastIndexOf("_"));
    var index = obj
        .getElementsByTagName("input")[0]
        .id.substr(
            obj.getElementsByTagName("input")[0].id.lastIndexOf("_") + 1
        );
...
function as_setgrd(objid, targetobj) {
    var str_buffer = new String(
        '<input id="' +
            ...
            '_txt" name="' +
            objid +
            '_txt" type="text" size="10" class="ctrltext" placeholder="請輸入" onkeypress="if (event.keyCode == 13){var setvalue=document.getElementById(\'' +
            objid +
            "_txt').value;setasgrdtxt(setvalue, " +
            objid +
            ",'" +
            targetobj +
            "');return false;}\" >" +
            '<button id="" onclick="var setvalue=document.getElementById(\'' +
            objid +
            "_txt').value;setasgrdtxt(setvalue, " +
            objid +
            ",'" +
            targetobj +
            "');return false;\">全部設定</button>" +
            '<button id="" onclick="clearasgrdtxt(' +
            objid +
            ",'" +
            targetobj +
            "');return false;\">全部清除</button>"
    );
    return str_buffer;
}
    ...
    if (obj) {
        ...
        if (objtag == "INPUT") {
            ...
            if (objtype == "hidden" && objid.indexOf("_hfcblvalue") != -1) {
                var showobj = document.getElementById(
                    objid.replace("_hfcblvalue", "_hshow")
                );
            ...
            for (var e = 0; e < elements.length; e++) {
                if (elements[e].getAttribute("type") == objtype) {
                    ...
                    if (eleid.indexOf(targetobj) != -1) {
                        if (
                            objtype == "checkbox" &&
                            elements[e].getAttribute("disabled") != "disabled"
                        ) {
                            elements[e].checked = objvalue;
                        }
                        if (
                            objtype == "hidden" &&
                            eleid.indexOf("_hfcblvalue") != -1
                        ) {
                            elements[e].value = objvalue;
                            var showele = document.getElementById(
                                eleid.replace("_hfcblvalue", "_hshow")
                            );
            ...
            if (objtag == "DIV") {
                ...
                if (
                    divChk.length > 0 &&
                    document.getElementById(objid + "_cbl") != null
                ) {
                    ...
                    for (var e = 0; e < setelements.length; e++) {
                        if (setelements[e].checked) {
                            ...
                            objvalue += setelements[e].id
                                .substring(setelements[e].id.lastIndexOf("_"))
                                .toString();
                        }
                        //s = s + elements[e].labels[0].innerText.toString().trim();
                    }
                    ...
                    var elements =
                        document.getElementsByClassName("ascblMulti");
                    for (var e = 0; e < elements.length; e++) {
                        ...
                        if (
                            document.getElementById(parentid + "_cbl") !=
                                null &&
                            eleid.indexOf(targetobj) != -1
                        ) {
                            var s = "";
                            var h = "";
                            ...
                            var lblRef = document.getElementById(
                                eleid.replace("_cblMulti2", "_hshow")
                            );
                            var hdlRef = document.getElementById(
                                eleid.replace("_cblMulti2", "_hdcheck")
                            );
                            var tarelements =
                                divRef.getElementsByTagName("input");

                            var h = objvalue.replace(
                                new RegExp(",", "g"),
                                "$|"
                            );
                            if (h.length > 0) {
                                ...
                                for (var t = 0; t < tarelements.length; t++) {
                                    if (
                                        ...
                                        s =
                                            s +
                                            tarelements[t].labels[0].innerText
                                                .toString()
                                                .trim();
                                    }
                                }
                ...
                if (objvalue != null) {
                    ...
                    for (var e = 0; e < elements.length; e++) {
                        if (elements[e].getAttribute("type") == "radio") {
                            ...
                            if (eleid.indexOf(targetobj) != -1) {
                                if (
                                    elements[e].getAttribute("disabled") !=
                                        "disabled" ||
                                    elements[e].getAttribute("disabled") == null
                                ) {
                    ...
                    if (objvalue != null) {
                        ...
                        for (var e2 = 0; e2 < elements.length; e2++) {
                            ...
                            if (eleid.indexOf(targetobj) != -1) {
                                if (
                                    objtype == "select-one" &&
                                    elements[e2].getAttribute("disabled") !=
                                        "disabled"
                                ) {
                                    var opelements =
                                        elements[e2].getElementsByTagName(
                                            "option"
                                        );
                                    for (
                                        var ope = 0;
                                        ope < opelements.length;
                                        ope++
                                    ) {
                                        if (opelements[ope].value == objvalue) {
                                            opelements[ope].selected =
                                                "selected";
                                        }
                                    }
                                }
...
function asSetOrder(obj, tarobjid, osort, otype) {
    ...
    if (otype == "") {
        if (
            uclassname.indexOf("Non") != -1 &&
            dclassname.indexOf("Non") != -1
        ) {
...
function showAssearch(obj) {
    function asAssearchKeyCtrl(e) {
        ...
        switch (key) {
            case 13: //Enter
                ...
                var objbtn = document.getElementById(
                    obj_parent.id + "_btnsearch"
                );
                objbtn.onclick();
                break;
            default:
            ...
            if (Captions.length > 0) {
                if (Captions[0].innerText) {
                    if (Captions[0].innerText.length != 0) {
                        ...
                        var contentsV =
                            objparent.getElementsByClassName("asContentV");
                        for (var ec = 0; ec < contentsV.length; ec++) {
                            var check =
                                contentsV[ec].getElementsByClassName(
                                    "asContentV"
                                );
                            if (check.length == 0) {
                                var ecinputs =
                                    contentsV[ec].getElementsByTagName("INPUT");
                                for (
                                    var eci = 0;
                                    eci < ecinputs.length;
                                    eci++
                                    ...
                                    if (
                                        ecinputs[eci].getAttribute("type") ==
                                        "text"
                                    ) {
                                        //執行搜尋
                                        ecinputs[eci].addEventListener(
                                            "keydown",
                                            asAssearchKeyCtrl,
                                            false
                                        );
                                ...
                                var ecselects =
                                    contentsV[ec].getElementsByTagName(
                                        "SELECT"
                                    );
                                for (
                                    var ecs = 0;
                                    ecs < ecselects.length;
                                    ecs++
                                ) {
                                    if (ecselects[ecs].value.length != 0) {
                                        if (Filterdata.length > 0)
                                            Filterdata += "_";
                                        var ecoptions =
                                            ecselects[ecs].getElementsByTagName(
                                                "OPTION"
                                            );
                                        for (
                                            var eco = 0;
                                            eco < ecoptions.length;
                                            eco++
                                        ) {
                                            if (ecoptions[eco].selected) {
                                                Filterdata +=
                                                    ecoptions[eco].innerText;
                                            }
                                        }
                        ...
                        var contentsH =
                            objparent.getElementsByClassName("asContentH");
                        for (var ecH = 0; ecH < contentsH.length; ecH++) {
                            var check =
                                contentsH[ecH].getElementsByClassName(
                                    "asContentH"
                                );
                            if (check.length == 0) {
                                var ecinputs =
                                    contentsH[ecH].getElementsByTagName(
                                        "INPUT"
                                    );
                                for (
                                    var eci = 0;
                        ...
                        if (Filterdata.length != 0) {
                            Filterstr +=
                                Captions[0].innerText + "(" + Filterdata + ") ";
                            Filtertitle +=
                                Captions[0].innerText + "(" + Filterdata + ") ";
                        }
                    }
    ...
    */
    ...
    var asSearchfilterhf = document.getElementById(
        objid.replace("_bar", "_hf")
    );
    var asSearchfilter = document.getElementById(
        objid.replace("_bar", "_filter")
    );
...
function showAssearch_week(Asdatetime, Asdatetime_type) {
    if (Asdatetime_type == "R") {
        Asdatetime =
            (Number(Asdatetime.substring(0, 3)) + 1911).toString() +
            Asdatetime.substring(3);
    }
    //加星期
    ...
    if (ddsrtop >= window.innerHeight) {
        showdiv.setAttribute(
            ...
            "top:" +
                (window.innerHeight -
                    newliH -
                    tmpobj.parentElement.offsetHeight) +
                "px;left:" +
                ddsrleft +
                "px;"
        );
...
function ddlImgChose(obj, objddl, clickDiv, ddldiv) {
    ...
    if (arrOpt) {
        ...
        var ddllab = document.getElementById(
            clickDiv.id.replace("_clickDiv", "_lab")
        );
        var ddlimg = document.getElementById(
            clickDiv.id.replace("_clickDiv", "_img")
        );
        if (ddllab && ddlimg) {
